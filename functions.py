...
def extract_using_llm(input_file: str, output_file: str, instructions: str):
    ...
    return [{"extracted_text_saved_to_location" : output_file,
...
def calculate_total_sales(database_file: str, output_file: str, ticket_type: str):
    ...
    return [{"output_saved_to_location" : output_file,
            "response" : "Task Done Successfully."}]  
...
def write_recent_logs(directory: str, output_file: str, num_files: int, num_lines: int, extension: str):
